...
@section('title', 'Edit Data Anak Yatim')

@section('content')
<div class="mb-4">
    <h2><i class="bi bi-pencil-square"></i> Edit Data Anak Yatim</h2>
        ...
        <form method="POST" action="{{ route('anak-yatim.update', $anakYatim) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('alamat') is-invalid @enderror" 
                          ...
                          name="alamat" 
                          rows="3"
                          placeholder="Masukkan alamat lengkap">{{ old('alamat', $anakYatim->alamat) }}</textarea>
                @error('alamat')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('kelas_saat_masuk') is-invalid @enderror" 
                    ...
                    <option value="Belum Sekolah" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Belum Sekolah' ? 'selected' : '' }}>Belum Sekolah</option>
                    <option value="Kelas 1 SD" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 1 SD' ? 'selected' : '' }}>Kelas 1 SD</option>
                    <option value="Kelas 2 SD" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 2 SD' ? 'selected' : '' }}>Kelas 2 SD</option>
                    <option value="Kelas 3 SD" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 3 SD' ? 'selected' : '' }}>Kelas 3 SD</option>
                    <option value="Kelas 4 SD" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 4 SD' ? 'selected' : '' }}>Kelas 4 SD</option>
                    <option value="Kelas 5 SD" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 5 SD' ? 'selected' : '' }}>Kelas 5 SD</option>
                    <option value="Kelas 6 SD" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 6 SD' ? 'selected' : '' }}>Kelas 6 SD</option>
                    <option value="Kelas 1 SMP" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 1 SMP' ? 'selected' : '' }}>Kelas 1 SMP</option>
                    <option value="Kelas 2 SMP" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 2 SMP' ? 'selected' : '' }}>Kelas 2 SMP</option>
                    <option value="Kelas 3 SMP" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 3 SMP' ? 'selected' : '' }}>Kelas 3 SMP</option>
                    <option value="Kelas 1 SMA" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 1 SMA' ? 'selected' : '' }}>Kelas 1 SMA</option>
                    <option value="Kelas 2 SMA" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 2 SMA' ? 'selected' : '' }}>Kelas 2 SMA</option>
                    <option value="Kelas 3 SMA" {{ old('kelas_saat_masuk', $anakYatim->kelas_saat_masuk ?? 'Belum Sekolah') == 'Kelas 3 SMA' ? 'selected' : '' }}>Kelas 3 SMA</option>
                </select>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('pendidikan_terakhir') is-invalid @enderror" 
                        ...
                        <option value="Belum Sekolah" {{ old('pendidikan_terakhir', $anakYatim->pendidikan_terakhir ?? 'Belum Sekolah') == 'Belum Sekolah' ? 'selected' : '' }}>Belum Sekolah</option>
                        <option value="TK" {{ old('pendidikan_terakhir', $anakYatim->pendidikan_terakhir ?? 'Belum Sekolah') == 'TK' ? 'selected' : '' }}>TK</option>
                        <option value="SD" {{ old('pendidikan_terakhir', $anakYatim->pendidikan_terakhir ?? 'Belum Sekolah') == 'SD' ? 'selected' : '' }}>SD</option>
                        <option value="SMP" {{ old('pendidikan_terakhir', $anakYatim->pendidikan_terakhir ?? 'Belum Sekolah') == 'SMP' ? 'selected' : '' }}>SMP</option>
                        <option value="SMA" {{ old('pendidikan_terakhir', $anakYatim->pendidikan_terakhir ?? 'Belum Sekolah') == 'SMA' ? 'selected' : '' }}>SMA</option>
                    </select>
            ...
            <div class="mb-3">
                ...
                <input type="date" 
                       ...
                       id="tanggal_masuk" 
                       name="tanggal_masuk" 
                       value="{{ old('tanggal_masuk', $anakYatim->tanggal_masuk->format('Y-m-d')) }}"
                       max="{{ date('Y-m-d') }}"
                       required>
                @error('tanggal_masuk')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            {{-- <div class="mb-3">
                ...
                <input type="date" 
                       ...
                       id="tanggal_keluar" 
                       name="tanggal_keluar" 
                       value="{{ old('tanggal_keluar', $anakYatim->tanggal_keluar?->format('Y-m-d')) }}">
                <small class="form-text text-muted">
                    Kosongkan untuk menghitung ulang otomatis dari kelas saat masuk (estimasi lulus SMA).
                    @if($anakYatim->estimasi_keluar)
                        Estimasi: <strong>{{ $anakYatim->estimasi_keluar->format('d/m/Y') }}</strong>
                    @endif
                </small>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_aktif" id="is_aktif_1" value="1"
                           {{ old('is_aktif', $anakYatim->is_aktif ? '1' : '0') == '1' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_aktif" id="is_aktif_0" value="0"
                           {{ old('is_aktif', $anakYatim->is_aktif ? '1' : '0') == '0' ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Upload foto baru jika ingin mengganti foto yang ada</small>
            </div>
            @endif
            ...
            <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                <a href="{{ route('anak-yatim.show', $anakYatim) }}" class="btn btn-secondary">
