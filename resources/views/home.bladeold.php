        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <p class="text-muted mb-3">
                    <strong>Yayasan Rumah Yatim Baiturrohim</strong> adalah lembaga sosial nirlaba yang berdiri sejak 2009,
...
Setelah lebih kurang 30 tahun berjalan, 
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            $programs = [
                ...
                ['icon'=>'bi-people-fill',      'color'=>'info',    'title'=>'Pemberdayaan Keluarga',
                 'desc'=>'Pendampingan dan pemberdayaan ekonomi keluarga anak yatim agar dapat mandiri secara finansial.'],
