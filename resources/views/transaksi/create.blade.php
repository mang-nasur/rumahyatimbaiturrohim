...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('transaksi.store') }}" enctype="multipart/form-data">
            ...
            <!-- Bukti File -->
            <h5 class="mb-3 mt-4 text-primary"><i class="bi bi-file-earmark-arrow-up"></i> Bukti Transaksi (Opsional)</h5>

            <div class="mb-3">
                <label for="bukti_file" class="form-label">Upload Bukti</label>
                <input type="file" 
...
// Initialize kategori options on page load if jenis is already selected
